...
function onAvatarChange(event) {
    ...
    if (imagesForm.avatar) {
        const reader = new FileReader();
        reader.onload = () => {
            avatarImageScr.value = reader.result;
        }
            ...
            <div class="border-t m-4 mt-0">
                <TabGroup>
                    ...
                    <TabPanels class="mt-2">
                        ...
                        <TabPanel>
                            <div class="mb-3">
                                <TextInput :model-value="searchFollowersKeyword" placeholder="Type to search" class="w-full"/>
                            </div>
                        ...
                        <TabPanel>
                            <div class="mb-3">
                                <TextInput :model-value="searchFollowingKeyword" placeholder="Type to search" class="w-full"/>
                            </div>
