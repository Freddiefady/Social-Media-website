    ...
    <div class="bg-white p-4 rounded mb-4">
        ...
        <div class="grid grid-cols-2 gap-3 lg:grid-cols-3 mb-3">
            <template v-for="attachment of post.attachments">
                ...
                <!-- Download -->
                    <button class="w-8 h-8 flex flex-col items-center justify-center rounded bg-gray-700 hover:bg-gray-800 text-gray-100 absolute right-2 top-2 cursor-pointer group opacity-0 group-hover:opacity-100 transition-all">
        ...
        <div class="flex gap-2">
            <button class="flex gap-1 items-center justify-center px-4 py-2 flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-lg">
